...
const totalPaidByLocation= bills.reduce(function(accumulator,currentValue){
    if(accumulator[currentValue.location]){accumulator[currentValue.location] += currentValue.total;}
    else{accumulator[currentValue.location]=currentValue.total;}
    return accumulator;
},{});
